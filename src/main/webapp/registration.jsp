...
<body>
	...
	<script type="text/javascript">
		...
		if (status == "invalidName") {
			swal("sorry bro", "please enter name ", "error");
		}
		if (status == "invalidEmail") {
			swal("sorry bro", "please enter email ", "error");
		}
		if (status == "invalidUpwd") {
			swal("sorry bro", "please enter a password ", "error");
		}
		if (status == "invalidconfirmPassword") {
			swal("sorry bro", "password do not match  ", "error");
		}
		if (status == "invalidUmobile") {
			swal("sorry bro", "please enter mobile number only 10 digit  ",
					"error");
		}
