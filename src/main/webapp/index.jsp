...
<title>my protfolio professor</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">i am professor</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To omkar (professor buddy)</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">java full stack devloper and web devlopement</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">i am java full stack web devloper and i have created a website in html csss js and java jdbc servlets jsp and mysql page to created.</p>
				</div>
